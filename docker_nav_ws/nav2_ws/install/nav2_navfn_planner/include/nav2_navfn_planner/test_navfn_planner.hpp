...
#ifndef NAV2_TEST_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
#define NAV2_TEST_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
...
class test_NavfnPlanner : public nav2_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  // Logger
  rclcpp::Logger logger_{rclcpp::get_logger("test_NavfnPlanner")};
...
#endif  // NAV2_TEST_NAVFN_PLANNER__NAVFN_PLANNER_HPP_
