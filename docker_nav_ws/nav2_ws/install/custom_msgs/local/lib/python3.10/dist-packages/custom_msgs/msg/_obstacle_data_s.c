...
bool custom_msgs__msg__obstacle_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._obstacle_data.ObstacleData", full_classname_dest, 43) == 0);
  }
  custom_msgs__msg__ObstacleData * ros_message = _ros_message;
  {  // x
...
PyObject * custom_msgs__msg__obstacle_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._obstacle_data");
