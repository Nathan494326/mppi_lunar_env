...
#include "custom_msgs/msg/detail/obstacle_data__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleData__ros_msg_type = custom_msgs__msg__ObstacleData;
...
static uint32_t _ObstacleData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ObstacleData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__ObstacleData;
    is_plain =
      (
...
static size_t _ObstacleData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__ObstacleData(
