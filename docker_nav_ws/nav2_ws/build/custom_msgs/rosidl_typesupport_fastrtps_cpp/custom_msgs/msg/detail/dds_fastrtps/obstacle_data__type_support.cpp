...
#include "custom_msgs/msg/detail/obstacle_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::ObstacleData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::ObstacleData & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::ObstacleData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::ObstacleData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::ObstacleData *>(
    untyped_ros_message);
...
static size_t _ObstacleData__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObstacleData(full_bounded, is_plain, 0);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_ObstacleData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, ObstacleData)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_ObstacleData__handle;
}
