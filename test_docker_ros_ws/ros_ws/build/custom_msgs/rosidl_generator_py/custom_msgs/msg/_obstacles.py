...
class Metaclass_Obstacles(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_msgs.msg import ObstacleData
            if ObstacleData.__class__._TYPE_SUPPORT is None:
                ObstacleData.__class__.__import_type_support__()
...
class Obstacles(metaclass=Metaclass_Obstacles):
    ...
    _fields_and_field_types = {
        ...
        'obstacles': 'sequence<custom_msgs/ObstacleData>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['builtin_interfaces', 'msg'], 'Time'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['custom_msgs', 'msg'], 'ObstacleData')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ObstacleData) for v in value) and
                 True), \
                "The 'obstacles' field must be a set or sequence and each value of type 'ObstacleData'"
