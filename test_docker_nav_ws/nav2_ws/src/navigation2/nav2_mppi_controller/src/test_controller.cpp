...
#include <stdint.h>
#include <chrono>
#include "nav2_mppi_controller/test_controller.hpp"
...
void test_MPPIController::configure(
...
void test_MPPIController::cleanup()
{
  optimizer_.shutdown();
...
void test_MPPIController::activate()
{
...
void test_MPPIController::deactivate()
{
  trajectory_visualizer_.on_deactivate();
  RCLCPP_INFO(logger_, "Deactivated MPPI Controller: %s", name_.c_str());
}

void test_MPPIController::reset()
{
  optimizer_.reset();
}

geometry_msgs::msg::TwistStamped test_MPPIController::computeVelocityCommands(
...
void test_MPPIController::visualize(nav_msgs::msg::Path transformed_plan)
{
...
void test_MPPIController::setPlan(const nav_msgs::msg::Path & path)
{
  path_handler_.setPath(path);
}

void test_MPPIController::setSpeedLimit(const double & speed_limit, const bool & percentage)
{
...
PLUGINLIB_EXPORT_CLASS(nav2_mppi_controller::test_MPPIController, nav2_core::Controller)
