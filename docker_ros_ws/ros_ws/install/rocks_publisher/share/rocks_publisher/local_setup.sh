...
: ${AMENT_CURRENT_PREFIX:="/workstation/ros_ws/install/rocks_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rocks_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rocks_publisher/environment/path.sh"
